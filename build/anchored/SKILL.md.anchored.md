...
<!-- ANCHOR: A-SK-3dafb31a L1 -->
## Step 1: P1-P12行星审计

**参考：resources/p1_p12.md**

<!-- ANCHOR: A-SK-1f6f90f1 L1 -->
### 数据来源
...
<!-- ANCHOR: A-SK-60de3e8c L1 -->
### Step 1前置：信号分诊（必须先做）

**像人类占星师一样，先扫一眼全盘，找出"尖叫信号"：**

<!-- ANCHOR: A-SK-15e8883d L2 -->
```
...
<!-- ANCHOR: A-SK-8b26d551 L1 -->
### Step 1前置：格局预扫描（必须先做）

**读取 resources/yogas.md，对全盘执行一次系统性格局扫描：**

<!-- ANCHOR: A-SK-5dc28d4b L2 -->
```
⚠️ 必须在行星逐星审计之前完成！
...
<!-- ANCHOR: A-SK-d61a57c2 L1 -->
### PAC联合判定（最重要的精准度规则）

<!-- ANCHOR: A-SK-c4f310ac L2 -->
```
错误方式（分层判断后拼凑）：
  P1=清理者 -> "这颗星有负面倾向"
  P7=入旺   -> "但状态很好"
...
**首次输出时附框架铺垫**：
<!-- ANCHOR: A-SK-ffe18f57 L2 -->
> "接下来我逐颗星帮你做个'体检'——
> 看每颗星在你人生里扮演什么角色、状态好不好、管的事情顺不顺。
> 先说结论，数据表附在后面供你对照。"

<!-- ANCHOR: A-SK-3ddfd8f3 L1 -->
### 每颗星输出格式
<!-- ANCHOR: A-SK-3ad31b98 L2 -->
```
...
<!-- ANCHOR: A-SK-719a4eed L1 -->
### 分组暂停
<!-- ANCHOR: A-SK-63833587 L2 -->
```
...
<!-- ANCHOR: A-SK-c26b0e5e L1 -->
### Step 1收尾：格局终判表（必须做）

<!-- ANCHOR: A-SK-79b1a55e L2 -->
```
...
<!-- ANCHOR: A-SK-e5e9e839 L1 -->
## Step 2: 分盘交叉分析

<!-- ANCHOR: A-SK-3e1f0edd L2 -->
...
<!-- ANCHOR: A-SK-bdc8d90a L1 -->
### 2.2 D10事业概述
<!-- ANCHOR: A-SK-346f5a81 L2 -->
```
...
<!-- ANCHOR: A-SK-2a701c1b L1 -->
### 2.3 D4财产概述
<!-- ANCHOR: A-SK-db2e6d94 L2 -->
```
...
<!-- ANCHOR: A-SK-80da0392 L1 -->
### 2.4 D5权力概述
<!-- ANCHOR: A-SK-33ac0463 L2 -->
```
...
<!-- ANCHOR: A-SK-4ef21d02 L1 -->
## ⏸️ 阶段1完成（自动暂停）

<!-- ANCHOR: A-SK-db6f4755 L2 -->
```
...
<!-- ANCHOR: A-SK-2ba23ac6 L1 -->
## 阶段2开始：强制数据回调

<!-- ANCHOR: A-SK-de233d9c L2 -->
```
...
<!-- ANCHOR: A-SK-f9de7a2d L1 -->
### 诊断框架
对12个宫位执行四维度分析：
<!-- ANCHOR: A-SK-8498b5bb L3 -->
1. **管理者**：宫主的身份(P1)+去向(落宫)+状态(P7/P9)
<!-- ANCHOR: A-SK-a01ab008 L3 -->
2. **租客**：宫内行星带来的资源或干扰
<!-- ANCHOR: A-SK-e1fe0f9d L3 -->
3. **相位**：哪些行星在看这个宫位，带来什么影响
<!-- ANCHOR: A-SK-a087b57d L3 -->
4. **硬件(SAV)**：仅在SAV极端值(>32或<20)时展开分析，中间值不展开

<!-- ANCHOR: A-SK-13d44d9c L1 -->
### 分盘交叉
在分析特定宫位时引用对应分盘：
- 4宫 → 引用D4数据
- 5宫 → 引用D5数据
...
<!-- ANCHOR: A-SK-afc5c4d6 L1 -->
### ⚠️ 12宫强制全覆盖

<!-- ANCHOR: A-SK-05e008b2 L2 -->
```
必须输出全部12个宫位，禁止跳过：
...
<!-- ANCHOR: A-SK-76b7cef0 L1 -->
### Step 3后置：Parivartana（互溶）扫描

**12宫诊断完成后，汇总全盘互溶关系：**

<!-- ANCHOR: A-SK-c83e62a1 L2 -->
```
...
<!-- ANCHOR: A-SK-9d1a2ffe L1 -->
## Step 5: 技术附录

写入 appendix.md：

<!-- ANCHOR: A-SK-948d61c6 L2 -->
```markdown
# 技术附录
...
<!-- ANCHOR: A-SK-de36cedd L1 -->
## 文件结构

<!-- ANCHOR: A-SK-7fe0dcd9 L2 -->
```
工作目录/
...
<!-- ANCHOR: A-SK-fbf30621 L1 -->
## 子skill路由 & 报告打包

分析完成后：

<!-- ANCHOR: A-SK-2b9ed3f2 L2 -->
```
🎯 核心分析完成！
...
<!-- ANCHOR: A-SK-7851c05d L1 -->
## 关键原则

<!-- ANCHOR: A-SK-d8c32c7e L3 -->
...
<!-- ANCHOR: A-SK-b29df521 L3 -->
2. **人文关怀（Q&A阶段）**：分析结论不改，但表达要考虑用户感受和已知经历。见qa_rules.md伦理约束
<!-- ANCHOR: A-SK-13a1de1f L3 -->
3. **不重算**：所有数据来自structured_data.md
<!-- ANCHOR: A-SK-d78daf4d L3 -->
4. **禁止幻觉**：所有结论必须基于数据
<!-- ANCHOR: A-SK-47a6e6b3 L3 -->
...
<!-- ANCHOR: A-SK-df0469f6 L3 -->
7. **代价必提**：带偏置信号必须明确副作用
<!-- ANCHOR: A-SK-2bccb278 L3 -->
8. **人话优先**：70%解读+20%数据+10%注释
<!-- ANCHOR: A-SK-38f1c2f0 L3 -->
9. **事件关联是陈述**：嵌入宫位分析，不单独设验证环节
<!-- ANCHOR: A-SK-e3a0c25c L3 -->
10. **分盘可信度**：⚠️标注的分盘，分析措辞留余地
<!-- ANCHOR: A-SK-d587e876 L3 -->
